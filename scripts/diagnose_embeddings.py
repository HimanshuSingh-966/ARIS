...
Run from anywhere:  python scripts/diagnose_embeddings.py
"""
import os
import sys
...
# so `from pipeline.embedder import ...` below cannot resolve without this. Same
# fixup pipeline/ingestor.py applies for its own script-mode invocation.
